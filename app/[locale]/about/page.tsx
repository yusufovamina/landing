                ...
                <div className="container-custom text-center">
                    <ScrollAnimation animation="fade-up">
                        <div className="inline-flex items-center gap-2 mb-6">
                            ...
                            <span className="text-sm text-gray-600">{t('hero.badge')}</span>
                        </div>
                        <h1 className="text-5xl font-bold mb-6 leading-tight" dangerouslySetInnerHTML={{ __html: t('hero.title') }} />
                        ...
                        <ScrollAnimation animation="slide-right">
                            <div>
                                ...
                                <div className="space-y-4">
                                    {[
                                        { text: t('vision.goals.goal1.text'), subtext: t('vision.goals.goal1.subtext') },
                                        { text: t('vision.goals.goal2.text'), subtext: t('vision.goals.goal2.subtext') },
                                        { text: t('vision.goals.goal3.text'), subtext: t('vision.goals.goal3.subtext') },
                                    ].map((item, i) => (
                                        <ScrollAnimation key={i} animation="fade-up" delay={i * 100}>
                        ...
                        <ScrollAnimation animation="slide-left" delay={200}>
                            <div className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
                                <div className="flex items-center gap-2 mb-6">
                                    ...
                                    <h3 className="text-xl font-bold">{t('values.title')}</h3>
                                </div>
                                <div className="space-y-4">
                                    {[
                                        { icon: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.924 10.29 9 11.622 5.076-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>, title: t('values.reliability.title'), desc: t('values.reliability.description') },
                                        { icon: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>, title: t('values.simplicity.title'), desc: t('values.simplicity.description') },
                                        { icon: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z" /></svg>, title: t('values.support.title'), desc: t('values.support.description') },
                                        { icon: <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>, title: t('values.development.title'), desc: t('values.development.description') },
                                    ].map((value, i) => (
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
                        ...
                        <ScrollAnimation animation="scale" delay={200}>
                            <div className="card text-center hover:shadow-xl">
                                ...
                                <p className="text-gray-600 mb-4">{t('contact.phone.description')}</p>
            ...
            <section className="section-padding bg-gray-50">
                <div className="container-custom text-center">
                    <ScrollAnimation animation="fade-up">
                        ...
                        <p className="text-gray-600 mb-8">{t('social.subtitle')}</p>
                    </ScrollAnimation>
